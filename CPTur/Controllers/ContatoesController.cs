...
namespace CPTur.Controllers
{
    public class ContatoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Assunto,Nome,Email,QtPessoas,Destino,Mensagem")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Assunto,Nome,Email,QtPessoas,Destino,Mensagem")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
