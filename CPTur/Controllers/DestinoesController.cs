...
namespace CPTur.Controllers
{
    public class DestinoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Tipo,Clima,Descricao")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Tipo,Clima,Descricao")] Destino destino)
        {
            if (id != destino.Id)
            {
                return NotFound();
